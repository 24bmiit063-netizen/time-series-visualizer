...
# Import data
df = pd.read_csv(r"C:\Users\Pratham\OneDrive\Desktop\freecode camp\project4\fcc-forum-pageviews.csv", parse_dates=["date"], index_col="date")
...
def draw_bar_plot():
    ...
    df_grouped = df_bar.groupby(["year", "month", "month_name"])["value"].mean()
